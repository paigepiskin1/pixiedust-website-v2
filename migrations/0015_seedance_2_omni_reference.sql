...
INSERT OR REPLACE INTO templates (
  ...
  '[{"key":"model_version","type":"select","asModel":true,"label":"Model","default":"dreamina-seedance-2-0-260128","options":[{"value":"dreamina-seedance-2-0-260128","label":"Seedance 2.0"},{"value":"dreamina-seedance-2-5-260628","label":"Seedance 2.5"}],"help":"Seedance 2.5 is newer — it must be activated in your BytePlus Ark Console first."},{"key":"references","type":"file","label":"Reference images","required":true,"multiple":true,"max":9,"accept":"image/png,image/jpeg,image/webp","help":"Upload references (Seedance 2.0 allows up to 9, Seedance 2.5 up to 30). They become @Image1, @Image2 and so on in upload order — tag them in your prompt below."},{"key":"prompt","type":"textarea","label":"Prompt","required":true,"mentionFrom":"references","mentionLabel":"Image","placeholder":"@Image1 as the main character, walking through the neon city from @Image2. Cinematic, slow dolly-in.","help":"Type @ to insert a reference (@Image1, @Image2 …), then say what each controls — identity, scene, or style. Order matches your uploads."}]',
  50,
  10,
  '[5,10,15,20,25,30]',
  '{"480p":0.6,"720p":1}',
