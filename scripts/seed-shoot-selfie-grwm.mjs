#!/usr/bin/env node
// Seed five GRWM / spa / tropical Selfie shoot presets into remote D1.
// Usage: node scripts/seed-shoot-selfie-grwm.mjs
...
const sql = join(root, "scripts/seed-shoot-selfie-grwm.sql");
