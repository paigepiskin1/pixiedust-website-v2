#!/usr/bin/env node
// Apply NYC Walk .5 outfit options to remote D1.
// Usage: node scripts/update-nyc-dot5-walk-outfit.mjs
...
const sql = join(root, "migrations/0017_nyc_dot5_walk_outfit.sql");
