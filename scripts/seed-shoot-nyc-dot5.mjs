#!/usr/bin/env node
// Seed the five NYC .5 shoot presets into remote D1.
// Usage: node scripts/seed-shoot-nyc-dot5.mjs
// Requires .dev.vars with CLOUDFLARE_API_TOKEN.
...
const sql = join(root, "scripts/seed-shoot-nyc-dot5.sql");
